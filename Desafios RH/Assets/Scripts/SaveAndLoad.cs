...
public class SaveAndLoad
{
    ...
    public void LoadFromJson() // Metodo de load
    {
        ...
        {
            string json = File.ReadAllText(Application.dataPath + "/Save.json"); // L� tudo do arquivo Json
            JsonUtility.FromJsonOverwrite(json, empresa); // Carrega os dados diretamente na inst�ncia existente
